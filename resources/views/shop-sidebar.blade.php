				...
				<ul class="nav navbar-nav">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-sm-3">
									<ul>
										...
										<li role="separator" class="divider"></li>
										<li><a href="product-single.blade.php">Product Details</a></li>
										<li><a href="shop-sidebar.blade.php">Shop With Sidebar</a></li>
							...
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										...
										<li role="separator" class="divider"></li>
										<li><a href="dashboard.blade.php">User Interface</a></li>
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										...
										<li><a href="signin.blade.php">Signin Page</a></li>
										<li><a href="forget-password.blade.php">Forget Password</a></li>
									</ul>
								</div>
					...
					<li class="dropdown dropdown-slide">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="blog-grid.blade.php">Blog 2 Columns</a></li>
					...
					<li class="dropdown dropdown-slide">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="alerts.blade.php">Alerts</a></li>
						</ul>
					</li><!-- / Blog -->
				</ul><!-- / .nav .navbar-nav -->
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.blade.php">Rainbow Shoes</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.blade.php">Strayhorn SP</a></h4>
						<p class="price">$230</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.blade.php">Bradley Mid</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			        	...
			        	<div class="row">
			        		...
			        		<div class="col-md-4 col-sm-6 col-xs-12">
			        			<div class="product-short-details">
			        				...
			        				<a href="product-single.blade.php" class="btn btn-transparent">View Product Details</a>
			        			</div>
			        		</div>
			        	</div>
			        </div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="footer-menu text-uppercase">
					...
					<li>
						<a href="contact.blade.php">PRIVACY POLICY</a>
					</li>
				</ul>
